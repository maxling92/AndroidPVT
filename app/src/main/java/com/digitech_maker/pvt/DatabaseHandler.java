...
public class DatabaseHandler extends SQLiteOpenHelper {
    ...
    public void addHasil(Hasil item, String namaobservant) {
        ...
        Cursor cursor = db.query(TABLE_USERS, new String[]{KEY_TGLLAHIR, KEY_PERUSAHAAN},
        ...
        values.put(KEY_NAMADATA, item.getNamadata());
    ...
    public List<Hasil> getAllHasil() {
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                Hasil hasil = new Hasil(namaobservant, tgllahirStr, namaPerusahaan);
